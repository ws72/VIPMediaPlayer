...
import com.mx.vipmediaplayer.database.SqliteHelperOrm;
...
public class FileUtils {
    ...
    public static String getExternalStorageDirectory() {
        ...
        Log.e("VIPPlayer", "FileUtils.getExternalStorageDirectory : " + path);
    ...
    public static List<VIPMedia> getAllSortFiles(int type) {
        SqliteHelperOrm db = new SqliteHelperOrm();
        try {
            Dao<VIPMedia, Long> dao = db.getDao(VIPMedia.class);
            QueryBuilder<VIPMedia, Long> query = dao.queryBuilder();
            query.orderBy("title_key", true);
            query.where().eq("filetype", type);
